...
export default function LandingPage() {
  ...
  return (
    <div>
      ...
      <h4 style={{ textAlign: 'center', fontFamily: 'Arial, sans-serif'  }}>Properties</h4>
      <h2 style={{ textAlign: 'center', fontFamily: 'Times New Roman' }}>Display Latest & Featured Properties</h2>
      <p style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto', fontFamily: 'Arial, sans-serif'  }}>
